...
1. **Update docs and skills** -- before building, review and update based on changes since the last release:
   - `app/src/main/assets/skills/about-oneclaw/SKILL.md` -- the LLM's knowledge base about OneClaw; update to reflect any new features, tools, architecture changes, data flow updates, or config changes
   ...
   - `docs/wiki/Tool-Reference.md` -- built-in tool reference (add new tools, update parameter tables)
   - `docs/wiki/Memory-System.md` -- memory system (search algorithm, git versioning, file layout)
   - `docs/wiki/Skill-System.md` -- skill loading architecture (frontmatter fields, invocation methods)
   - `docs/wiki/Features.md` -- feature overview (add new features, update counts)
