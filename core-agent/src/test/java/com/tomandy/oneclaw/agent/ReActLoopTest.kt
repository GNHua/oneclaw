...
import com.tomandy.oneclaw.llm.Choice
import com.tomandy.oneclaw.llm.FunctionCall
import com.tomandy.oneclaw.llm.LlmClient
import com.tomandy.oneclaw.llm.LlmResponse
import com.tomandy.oneclaw.llm.MessageResponse
...
class ReActLoopTest {
    ...
    private val testMessages = listOf(
        com.tomandy.oneclaw.llm.Message(role = "user", content = "Hello")
    )
