...
object NotificationMediaServiceManager {
    ...
    private var serviceRef: WeakReference<PalmClawNotificationListenerService>? = null
    private var promptCallback: NotificationListenerPromptCallback? = null

    fun registerService(service: PalmClawNotificationListenerService) {
    ...
    fun getActiveMediaSessions(context: Context): List<MediaController> {
        return try {
            ...
            val component = ComponentName(context, PalmClawNotificationListenerService::class.java)
