...
class CronjobManagerRescheduleTest {
    ...
    fun setup() {
        ...
        mockContext = mockk {
            ...
            every { packageName } returns "com.tomandy.palmclaw"
        }
